...
const NewUserMaintenance = () => {
  ...
  useEffect(() => {
    const fetchPermissions = async () => {
      try {
        ...
        console.log('General permissions data:', data);
        if (data) {
          const adminPermissions = data?.administration || {};
          ...
          setAdministrationPermissions(adminPermissions);
          console.log('Administration permissions:', adminPermissions);
        }
      } catch (err) {
  ...
  const PermissionsList = ({
    ...
    return (
      <div key={featureKey} className="row justify-content-center">
              ...
              <div key={feature} className="col-12 col-xl-5">
                <CheckboxAccordion
                  ...
                  onPermissionsChange={(newPermissions) => {
                    // Auto-check view when edit is checked - ONLY for transactions section
                    ...
                    if (sectionType === 'administration' && feature === 'branch_selection') {
