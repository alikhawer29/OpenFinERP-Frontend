        ...
        <div className="px-sm-5">
          <Formik
            ...
            initialValues={{
              ...
              vat_exempted: editDetails?.data?.current_vat_exempted,
            }}
...
export default withModal(withFilters(VATReportExpense));
