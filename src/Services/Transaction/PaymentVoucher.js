...
// CREATE
export const createPaymentVoucher = async (formData) => {
  try {
    const payload = new FormData();
    buildFormData(payload, formData);
    const response = await axiosInstance.post(
      '/user-api/payment-voucher',
      payload
    );
    const {
...
// UPDATE
export const updatePaymentVoucher = async (id, formData) => {
  try {
    const payload = new FormData();
    buildFormData(payload, formData);
    const response = await axiosInstance.post(
      `/user-api/payment-voucher/${id}`,
      payload
    );
    const {
      data: { message, status, detail },
...
export const addPaymentVoucherAttachment = async (id, formData) => {
  try {
    ...
    buildFormData(payload, formData);
    const response = await axiosInstance.post(
      `/user-api/payment-voucher/attachments/${id}`,
      payload
    );
    const {
      data: { message, status },
